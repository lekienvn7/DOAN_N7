      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-[18px]">
            ...
            <div className="text-[17px] text-[var(--text-primary)] space-y-[6px]">
              <p>
                <span className="text-highlightcl font-semibold">Chức vụ:</span>{" "}
                {user?.roleName}
              </p>
              <p>
                <span className="text-highlightcl font-semibold">Email:</span>{" "}
                {user?.email || "Không có"}
              </p>
              <p>
                <span className="text-highlightcl font-semibold">SĐT:</span>{" "}
                {user?.phone || "Không có"}
              </p>
            </div>

            <p className="text-[15px] text-[var(--text-tertiary)] max-w-[520px]">
              Chúc bạn một ngày làm việc hiệu quả. Theo dõi kho vật tư, thông
              báo và tình hình hệ thống ngay tại đây.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-[36px] items-start">
          ...
          >
            <div className="flex justify-between items-center mb-[24px]">
              <p className="text-[34px] font-bold gradient-text">
                Danh sách kho
              </p>
              <p className="text-[20px] font-semibold text-[var(--text-tertiary)]">
                Tổng loại vật tư
              </p>
            </div>
          ...
          <motion.div
            ...
            "
          >
            <p className="text-[34px] font-bold gradient-text mb-[20px]">
              Thông báo
            </p>
            <NoticePage />
          </motion.div>
