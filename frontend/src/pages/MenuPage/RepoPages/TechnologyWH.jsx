...
import TechnologyList from "@/components/RepoPage/TechnologyWH/TechnologyList/TechnologyList";
import AddTechnology from "@/components/RepoPage/TechnologyWH/AddTechnology";
    ...
    <div className="min-h-screen bg-[var(--bg-page)] text-[var(--text-primary)] flex flex-col">
      ...
      <main className="mt-[56px] flex flex-col gap-[20px]">
        ...
        {canAddMaterial && (
          ...
          >
            <AddTechnology onReload={reloadList} />
          </motion.section>
        )}
