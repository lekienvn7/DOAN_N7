...
import AutomotiveList from "@/components/RepoPage/AutomotiveWH/AutomotiveList/AutomotiveList";
import AddAutomotive from "@/components/RepoPage/AutomotiveWH/AddAutomotive";
...
const AutomotiveWH = () => {
  ...
  // thay bằng repoId kho automotive trong DB
  const repoId = "690981405de9a612110089dd";
    ...
    <div className="min-h-screen bg-[var(--bg-page)] text-[var(--text-primary)] flex flex-col">
      ...
      <main className="mt-[56px] flex flex-col gap-[20px]">
        ...
        {canAddMaterial && (
          ...
          >
            <AddAutomotive onReload={reloadList} />
          </motion.section>
        )}
