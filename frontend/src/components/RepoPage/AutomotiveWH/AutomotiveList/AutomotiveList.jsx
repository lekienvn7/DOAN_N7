...
import AutomotiveCarousel from "./AutomotiveCarousel";

const STORAGE_KEY = "automotive_search_history";

const AutomotiveList = ({ reload }) => {
  ...
  return (
    <section>
        ...
        <div ref={boxRef} className="relative w-[320px]">
          ...
          >
            <input
              ...
              placeholder="Tìm linh kiện, phụ tùng ô tô…"
              className="
      ...
      >
        <AutomotiveCarousel reload={reload} searchData={searchData} />
      </motion.div>
    </section>
  );
};
