              ...
              <Dialog open={openBorrow} onOpenChange={setOpenBorrow}>
                <DialogTrigger asChild>
                  ...
                  >
                    <Bell
                      className={`${
                        highlight ? "text-[#fdd700]" : "text-textpri"
                      } hover:text-[#fdd700] hover:scale-[1.05] active:scale-[0.95] transition-all duration-100 cursor-pointer`}
                    />
                  </div>
                </DialogTrigger>
                ...
                <DialogContent className="bg-[#1a1a1a] rounded-[12px] !max-w-none w-fit gap-[20px] items-center border-none text-white ">
                  <DialogHeader>
                    <DialogTitle className="text-[20px] text-[#fdd700]">
