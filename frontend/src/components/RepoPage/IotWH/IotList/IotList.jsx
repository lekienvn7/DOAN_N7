...
const STORAGE_KEY = "iot_search_history";

const IotList = ({ reload }) => {
  ...
  return (
    <section>
        ...
        <div ref={boxRef} className="relative w-[320px]">
          <div
            className="
              ...
              focus-within:border-[var(--accent-teal)]
              transition
            "
          >
            <input
              ...
              placeholder="Tìm cảm biến, board mạch, module IoT…"
              className="
      ...
      >
        <IotCarousel reload={reload} searchData={searchData} />
      </motion.div>
    </section>
  );
};
