...
const HeaderDetail = ({
  ...
  useEffect(() => {
    const fetchRepository = async () => {
      try {
        ...
        console.error("Lỗi kết nối dữ liệu kho cơ khí!", error);
        toast.error("Lỗi khi kết nối dữ liệu kho cơ khí!");
      }
    };
  ...
  useEffect(() => {
    const historyKey = "mechanical_search_history";
  ...
  const handleExport = async () => {
    try {
      const res = await axiosClient.get("/export/mechanical/export-excel", {
        responseType: "blob",
      });
      ...
      link.href = url;
      link.setAttribute("download", "kho-coKhi.xlsx");
  ...
  return (
    <div className=" flex flex-col p-[20px] w-[100vw] h-[150px] bg-bgmain border-t-1 border-gray-700">
      <div className="flex flex-col gap-[5px]">
        <AnimatePresence>
          ...
          >
            <div className="flex flex-col gap-[5px]">
              <p
                className="text-left text-[16px] text-[#e6eef2]
[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] font-satoshi "
              >
                Kho cơ khí
              </p>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              <DialogTrigger asChild>
                <button
                  ...
                  className="pr-3 cursor-pointer flex flex-row gap-[10px] hover:text-[#e6eef2]
hover:[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] transition-colors duration-300"
                >
...
[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)]"
                ...
                <AddMechanical onReload={onReload} />
              </DialogContent>
            </Dialog>
            ...
            <button
              ...
              className="pl-3 cursor-pointer flex flex-row gap-[10px] hover:text-[#e6eef2]
hover:[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] transition-colors duration-300"
            >
          ...
          <div className="flex flex-row relative">
            <div className=" flex flex-row">
              ...
              >
                {showSearch ? (
                  <ChevronsRight
                    className={`searchClose cursor-pointer hover:text-[#e6eef2]
hover:[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] mr-[15px] transition-colors duration-300 text-[#e6eef2]
[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] no-outline`}
                    size={18}
                  />
                ) : (
                  <Search
                    className={`searchTool cursor-pointer hover:text-[#e6eef2]
hover:[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] mr-[15px] transition-colors duration-300 text-[#A1A1A6] no-outline`}
                    size={18}
                  />
                )}
              </button>
            ...
            {showHistory && history.length > 0 && (
              <motion.div
                ...
                className="absolute top-[30px] left-[35px] w-[270px] max-h-[200px] overflow-y-auto scrollbar-thin scrollbar-thumb-[#c7a7ff]/50 hover:scrollbar-thumb-[#e8d6ff]/60  bg-[#111111] border border-gray-400 border-t-[#e6eef2] rounded-lg shadow-xl z-20"
              >
...
[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)]`
                      : "text-[#A1A1A6] "
                  } cursor-pointer text-[#A1A1A6]
[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] hover:text-textpri transition-colors duration-300`}
                  size={18}
                />
              </button>
              ...
              >
                <Download
                  className="text-[#A1A1A6] cursor-pointer hover:text-[#e6eef2]
hover:[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] transition-colors duration-300"
                  size={18}
                />
              </button>
...
hover:[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] transition-colors duration-300"
            ...
            <button
              ...
              className="text-[14px] ml-[5px] flex flex-row gap-[10px] hover:text-[#e6eef2]
hover:[text-shadow:0_0_1px_rgba(230,238,242,0.7),0_0_3px_rgba(230,238,242,0.5),0_0_5px_rgba(230,238,242,0.3)] transition-colors duration-300 cursor-pointer ml-[15px]"
            >
