...
const MechanicalCarousel = ({ reload, searchData }) => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      axiosClient.get("/repository/material/mechanical").then((res) => {
        if (res.data?.success) {
...
export default MechanicalCarousel;
