...
const STORAGE_KEY = "technology_search_history";

const TechnologyList = ({ reload }) => {
  ...
  return (
    <section>
        ...
        <div ref={boxRef} className="relative w-[320px]">
          ...
          >
            <input
              ...
              placeholder="Tìm RAM, ổ cứng, card mạng…"
              className="
      ...
      >
        <TechnologyCarousel reload={reload} searchData={searchData} />
      </motion.div>
    </section>
  );
};
