  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className=" w-[1300px] max-h-[465px] overflow-y-auto scrollbar-thin scrollbar-thumb-[#60a5fa]/50 hover:scrollbar-thumb-[#f9d65c]/60 p-[0px] bg-bgmain border-t-1 border-gray-700"
      >
        <TechnologyList
          key={reload}
          mode={mode}
