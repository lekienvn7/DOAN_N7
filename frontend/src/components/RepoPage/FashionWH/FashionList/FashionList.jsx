...
const STORAGE_KEY = "fashion_search_history";

const FashionList = ({ reload }) => {
  ...
  return (
    <section>
        ...
        <div ref={boxRef} className="relative w-[320px]">
          <div
            className="
              ...
              focus-within:border-[var(--accent-pink)]
              transition
            "
          >
            <input
              ...
              placeholder="Tìm vải, trang phục, phụ kiện…"
              className="
      ...
      >
        <FashionCarousel reload={reload} searchData={searchData} />
      </motion.div>
    </section>
  );
};
